...
pub(crate) type CoordinatorJobEvent = coordinator_runtime::CoordinatorJobEvent;
pub(crate) type CoordinatorMergeEvent = coordinator_runtime::CoordinatorMergeEvent;
...
pub(crate) fn resolve_phase_runner_native(
    repo_root: &std::path::Path,
    worktree_path: &std::path::Path,
    tool: &str,
) -> Result<Option<std::path::PathBuf>> {
...
pub(crate) fn build_phase_prompt_native(
    mode: &str,
    task_id: &str,
    tool: &str,
...
pub(crate) async fn spawn_merge_job_native(
    repo_root: &std::path::Path,
    task_id: &str,
    branch: &str,
    base: &str,
...
pub(crate) fn spawn_performer_job_native(
    repo_root: &std::path::Path,
    task_id: &str,
    worktree_path: &std::path::Path,
    ...
    coordinator_runtime::spawn_performer_job(
        &executable,
        repo_root,
        task_id,
        worktree_path,
